...
message.channel.send('https://discord.gg/FfBHCv75SP')
}
})
//
client.on("message", async(message) => {
if(message.content === "!ip") {
message.channel.send('IP adresimiz; 45.10.56.20 \nTıkla Bağlan; steam://connect/45.10.56.20:27015');
}
})
//
client.on("message", async(message) => {
...
client.on("message", async(message) => {
  ...
  message.channel.send(' @here İstiklal Jailbreak Sunucumuz Aktif | İP : steam://connect/45.10.56.20:27015 | Lütfen Müsait Olan Üyelerimiz Ve Yetkililerimiz Sunucuya Girebilirmi.')
  }
  })
  //
  client.on("message", async(message) => {
    if(message.content === "!steamid") {
    message.channel.send('https://www.youtube.com/watch?v=8DNyfxRHOFI')
    }
    })
